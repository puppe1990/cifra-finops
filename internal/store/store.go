...
type Store interface {
	...
	SetActiveTenant(userID, tenantID int64) error
	...
	ReplaceResources(accountID int64, resources []models.CloudResource) error
	ListResourcesForTenant(tenantID int64) ([]models.CloudResource, error)
	ListResources(accountID int64) ([]models.CloudResource, error)
	ReplaceCostLines(accountID int64, lines []models.CostLine) error
	ListCostLines(accountID int64) ([]models.CostLine, error)
	ReplaceFindings(accountID int64, findings []models.Finding) error
	ListFindings(accountID int64) ([]models.Finding, error)
	ListFindingsForTenant(tenantID int64) ([]models.Finding, error)
	StartSyncRun(accountID int64) (int64, error)
	FinishSyncRun(id int64, status, source, warning, errText string) error
	LastSyncRun(accountID int64) (models.SyncRun, error)
	CreateBudget(b models.Budget) (int64, error)
	ListBudgets(tenantID int64) ([]models.Budget, error)
