...
var ptMessages = map[string]string{
	...
	"amplify.hint.BuildDuration":                 "Minutos de build e deploy. Cobrado por minuto após a franquia mensal gratuita.",
	"amplify.hint.DataStorage":                   "Armazenamento do artefato de build no CDN, cobrado por GB/mês e recorrente enquanto o app existir.",
	"amplify.hint.DataTransferOut":               "Dados servidos aos usuários (GB transferidos) a partir do CDN.",
	"amplify.hint.HostingComputeRequestCount":    "Requisições SSR processadas por apps com compute (ex.: Next.js SSR).",
	"amplify.hint.HostingComputeRequestDuration": "Tempo de compute gasto nas requisições SSR, cobrado por GB-hora.",
	...
	"dash.aws_creds":                             "O Cifra não autenticou na AWS. Este servidor não tem instance role — vincule access keys em Contas em vez da cadeia ~/.aws.",
	"dash.month_fmt":                             "%s %d",
	"dash.m01":                                   "jan",
	"dash.m02":                                   "fev",
	"dash.m03":                                   "mar",
	...
	"acc.mode_chain_help": "A cadeia padrão só funciona com ~/.aws ou instance role. Num VPS, use access keys.",
	"acc.submit":          "Vincular",
